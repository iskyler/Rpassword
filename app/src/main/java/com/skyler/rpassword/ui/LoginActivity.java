...
public class LoginActivity extends Activity implements LoaderCallbacks<Cursor>{
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Button mEmailSignUpButton = (Button) findViewById(R.id.login_sign_up);
    ...
    public void login(final String email, final String password) {
        ...
        AsyncHttpResponseHandler handler = new AsyncHttpResponseHandler() {
            ...
            public void onFailure(int i, Header[] headers, byte[] bytes, Throwable throwable) {
                showProgress(false);
                Toast.makeText(LoginActivity.this,
                        getString(R.string.fail_login), Toast.LENGTH_SHORT)
                        .show();

                //TODO: tell what the err is
            }
        };
        HTTPClient.post(LoginActivity.this, "login", new Header[]{}, params, handler);
    }
